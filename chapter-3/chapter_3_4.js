...
function chapter_3_4() {
    ...
    captionElement.innerHTML = "Comparison of the KANs and MLPs based on different criterions.";
    ...
    var data = [
        {
            model: "MLP",
            values: [1.0, 0.5, 0.5, 1.0, 0.75] // baseline values
        },
        {
            model: "KAN",
            values: [0.5, 1.0, 1.0, 0.5, 0.75] // relative values (better=1.0, similar=0.75, worse=0.5)
        }
    ];
